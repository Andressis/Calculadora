...
const explicacoes = {
    ...
    juros_simples:         "<b>C:</b> capital, <b>i:</b> taxa em % (ex: 5 = 5% ao mês), <b>t:</b> períodos, <b>Adição Mensal:</b> valor depositado todo mês (opcional, padrão 0).<br><small>💡 Teste: C=1000, i=5, t=12, adição=100 → simula aportes mensais</small>",
    juros_compostos:       "<b>C:</b> capital, <b>i:</b> taxa em % (ex: 5 = 5% ao mês), <b>t:</b> períodos, <b>Adição Mensal:</b> valor depositado todo mês (opcional, padrão 0).<br><small>💡 Teste: C=1000, i=5, t=12, adição=100 → simula aportes mensais</small>",
...
const inputMap = {
    ...
    juros_simples:         { C:'js_C', i:'js_i', t:'js_t', aporte:'js_aporte' },
    juros_compostos:       { C:'jc_C', i:'jc_i', t:'jc_t', aporte:'jc_aporte' },
...
const labelMap = {
    ...
    juros:'Juros (R$)', montante:'Montante (R$)', aporte_total:'Total Aportado (R$)',
